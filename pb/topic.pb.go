...
type Topic struct {
	...
	Count     uint64 `protobuf:"varint,2,opt,name=Count,proto3" json:"Count,omitempty"`         //消息总数
	ReadCount uint64 `protobuf:"varint,3,opt,name=ReadCount,proto3" json:"ReadCount,omitempty"` //已读消息数
}
...
func (x *Topic) GetReadCount() uint64 {
	if x != nil {
		return x.ReadCount
	}
	return 0
...
var file_topic_proto_rawDesc = []byte{
	...
	0x62, 0x22, 0x4f, 0x0a, 0x05, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x12, 0x12, 0x0a, 0x04, 0x4e, 0x61,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x52, 0x65, 0x61, 0x64, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x52, 0x65, 0x61, 0x64, 0x43, 0x6f, 0x75,
